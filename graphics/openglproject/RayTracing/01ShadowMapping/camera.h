...
public:
    ...
    {
        QMatrix4x4 temp;
        temp.lookAt(Position, Position + Front, Up);
        return temp;
    }
...
private:
    ...
    void updateCameraVectors()
    {
        ...
        auto temp = QVector3D::crossProduct(Front, WorldUp);
        Right = temp.normalized();
        auto temp2 = QVector3D::crossProduct(Right, Front);
        Up = temp2.normalized();
    }
};
#endif